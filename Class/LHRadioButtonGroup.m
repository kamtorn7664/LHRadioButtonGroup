...
@implementation LHRadioButtonGroup
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        for(int i=0;i<([options count]/columns);i++){
            for(int j=0;j<columns;j++){
                ...
                [btTemp setImage:[UIImage imageNamed:@"r_off.png"] forState:UIControlStateNormal];
...
-(IBAction) radioButtonClicked:(UIButton *) sender{
    for(int i=0;i<[self.radioButtons count];i++){
        [[self.radioButtons objectAtIndex:i] setImage:[UIImage imageNamed:@"r_off.png"] forState:UIControlStateNormal];
        
    }
    [sender setImage:[UIImage imageNamed:@"r_on.png"] forState:UIControlStateNormal];
...
-(void) setSelected:(int) index{
    ...
    [[self.radioButtons objectAtIndex:index] setImage:[UIImage imageNamed:@"r_on.png"] forState:UIControlStateNormal];
